...
플레이어는 데미지를 입었을 때 Mesh의 머티리얼을 빨간색으로 변경하여


시각적으로 알 수 있게 표현 하였고 일정시간 동안 무적 판정을 주어 연속해서 데미지를 입지 않도록 하였습니다.


## 발사되는 플랫폼(?)
![녹화_2025_03_11_14_38_24_729](https://github.com/user-attachments/assets/4948159b-1c47-4eae-afbd-d1eaff4b766d)


점프대와 동일한 코드를 사용했으며 앞에 있던 점프대와 다르게 점프 중 이동하지 못하게 하여 정해둔 위치로 날아갈 수 있도록 해주었습니다.


## 보스전 / 레버 함정
![녹화_2025_03_11_14_38_41_776](https://github.com/user-attachments/assets/a2b395a0-cb98-4bd5-a88c-599908cf3ae0)


보스 몬스터는 NavMeshAgent를 추가하여 AI를 통해 이동하도록 해주었습니다.


플레이어와 일정 거리만큼 가까워지면 플레이어에게로 이동하며


공격 가능 범위에 플레이어가 있다면 이동을 멈춘 후 공격을 하도록 해주었습니다.


레버 함정의 경우 레버 오브젝트 한개의 함정 오브젝트들을 자식오브젝트로 두어


레버를 당겼을 때 모든 함정들이 활성화되도록 해주었습니다.


함정이 활성화 되면 스크립트에서 NavMeshObstacle를 활성화 하고 Carve 옵션을 켜주어


보스 몬스터가 함정 위로 이동하지 않도록 하여


보스 몬스터가 함정 위에 있을 때 발동시켜야 제대로 적중 시킬 수 있도록 하였습니다.


## 버프 아이템 / 클리어
![클리어](https://github.com/user-attachments/assets/ed44fa23-7a80-4ea8-987b-6de892abf5e2)


버프 아이템을 사용하게 되면 코루틴이 실행되며 일정시간 동안 정해진 버프가 적용되게 됩니다.


스피드 증가 포션을 사용하게 되면 정해진 시간 동안 스피드에 포션 증가값을 더해주어 빠르게 이동 할 수 있도록 하였고


무적 포션을 사용하게 되면 정해진 시간 동안 bool값인 무적을 활성화 시켜 데미지를 입지 않도록 해주었습니다.


보스를 쓰러트리게 되면 2초 정도 딜레이를 주어 애니메이션이 모두 재생되고 나서 파괴되도록 해주었습니다.
